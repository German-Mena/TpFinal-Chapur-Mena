            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <div class="col-md-4">
                        ...
                        <asp:Button ID="btnIngresar" runat="server" Text="Ingresar" CssClass="btn btn-primary" OnClientClick="return validarUsuario()" onclick="btnIngresar_Click1" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="accordion-body">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <%--<div id="txtNuevoUser" class="form-text">Elegi el nombre de tu usuario</div>--%>
                        ...
                        <asp:Button Text="Ingresar" ID="btn_nuevoUser" OnClientClick="return validarNuevoUsuario()" OnClick="btn_nuevoUser_Click" CssClass="btn btn-primary" runat="server"/>
                    </div>
                </div>
            </div>
        </div>
